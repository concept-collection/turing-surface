...
%
% This is the 12-transform reference: the correction evaluates lap_g in
% Cartesian-gradient form (Algorithm 4 of evolving_surface/notes/algos.tex),
% carrying grad_g(u) as three ambient components through the inverse metric
% quantities Vt*/Vp*. models/schnakenberg.m computes the same operator in
% flux form with 6 transforms per species per iteration
